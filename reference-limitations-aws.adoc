...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Zeigen Sie Einschränkungen für Cloud Volumes ONTAP in AWS C2S an"^].
