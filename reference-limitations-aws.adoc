...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Zeigen Sie Einschränkungen für Cloud Volumes ONTAP in AWS C2S an"^].
